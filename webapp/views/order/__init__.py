...
def save_order_view():
    ...
    if form.validate_on_submit():
        if update_or_create_order(
                id=form.id.data,
                title=form.title.data,
                carrier_id=form.carrier_id.data,
                consignee_id=form.consignee_id.data,
                consignee_address=form.consignee_address.data,
                consignee_contact_id=form.consignee_contact_id.data,
                consignee_phone=form.consignee_phone.data,
                declared=form.declared.data,
                desc=form.desc.data,
                point_from_id=form.point_from_id.data,
                point_to_id=form.point_to_id.data,
                shipper_id=form.shipper_id.data,
                shipper_address=form.shipper_address.data,
                shipper_contact_id=form.shipper_contact_id.data,
