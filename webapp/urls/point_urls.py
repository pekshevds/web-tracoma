...
def get_point_blueprints():
    ...
    point.add_url_rule('/show/<int:id>', endpoint='show_point', view_func=PointView.as_view('show_point'))
    point.add_url_rule('/new', endpoint='new_point', view_func=PointView.as_view('new_point'))
    point.add_url_rule('/delete/<int:id>', endpoint='delete_point', view_func=PointView.delete_point_view)
